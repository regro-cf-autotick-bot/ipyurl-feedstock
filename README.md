...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipyurl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13595&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipyurl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipyurl` can be installed with:

```
conda install ipyurl
```

It is possible to list all of the versions of `ipyurl` available on your platform with:
